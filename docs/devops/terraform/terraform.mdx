...
- Inicialmente para aprendizado podemos utilizar o provider local onde temos no site da [HashiCorp Local Provider](https://registry.terraform.io/providers/hashicorp/local/latest)
```bash .tf
terraform {
  required_providers {
    local = {
