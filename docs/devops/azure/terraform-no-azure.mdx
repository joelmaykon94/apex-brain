...
```
- No [Github Azure Blob](https://github.com/joelmaykonTADS/apex-brain/blob/main/devops/terraform/azure/storage_blob/main.tf) podemos encontrar como criar esse recurso na Azure

### App Service
- Trabalha com Windows e Linux
- Auto Scale
- Load Balance
- Monitoramento com Azure Monitor
- Usar o CDN da Azure
- Ter a segurança do WAF
- Utilizar conexões híbridas
<img
  style={{ borderRadius: '0.5rem' }}
  src="https://mintlify-assets.b-cdn.net/bigbend.jpg"
/>
> mais informaçoes no [Documentação Microsoft - App Service](https://learn.microsoft.com/pt-br/azure/app-service/)