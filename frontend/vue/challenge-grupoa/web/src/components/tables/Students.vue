...
<script>
import BtnDelete from "@/components/alerts/DeleteStudent";
import BtnRegister from "@/components/buttons/RegisterStudent";
import BtnEdit from "@/components/buttons/EditStudent";
